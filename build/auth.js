import { AUTH0_AUDIENCE, AUTH0_DOMAIN, MYBANK_API_1_AUDIENCE, MYBANK_API_1_AUTH0_DOMAIN, setMcpAccessToken, } from "./config.js";
 ...
 */
export const mcpMetadataRouter = () => {
...
export async function validateAPI1Token(token) {
    try {
